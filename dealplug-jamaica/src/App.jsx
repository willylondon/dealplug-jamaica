          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {categories.map((cat) => (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-full font-semibold whitespace-nowrap transition-all ${activeCategory === cat.id
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {displayedDeals.map((deal, index) => (
              <article
                key={deal.id}
                className={`bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden card-hover ${visibleDeals.includes(index) ? 'deal-enter' : 'opacity-0'
                  }`}
